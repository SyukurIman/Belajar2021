package com.example.belajar2021.SaveOpen
...
import com.example.belajar2021.SaveOpen.SaveData.FileHelper
import com.example.belajar2021.SaveOpen.SaveData.FileModel
import com.example.belajar2021.databinding.ActivityOpenSaveActivityBinding
import java.io.File
import java.util.*
import kotlin.collections.ArrayList

class open_save_activity : AppCompatActivity(), View.OnClickListener {
    private  lateinit var binding: ActivityOpenSaveActivityBinding
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOpenSaveActivityBinding.inflate(layoutInflater)
